...
/** Utility functions used by the zotova Qt UI.
 */
namespace GUIUtil
{
...
// Render ZOA addresses in monospace font
...
// Parse "zotova:" URI into recipient object, return true on successful parsing
