...
// Copyright (c) 2017-2020 The ZOA developers
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZOA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zotova: URIs)"));
...
//    connect(proposalAction, SIGNAL(triggered()), this, SLOT(gotoProposalPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zotova"), this);
    aboutAction->setStatusTip(tr("Show information about Zotova"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zotova"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZOA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZOA addresses"));
    ...
    openAction->setStatusTip(tr("Open a zotova: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zotova help message to get a list with possible zotova command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zotova client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zotova network", "", count));
}
...
{
    QString strTitle = tr("Zotova"); // default title
