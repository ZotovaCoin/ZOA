...
// Copyright (c) 2018-2020 The ZOA developers
...
#define NEWS_URL "https://zotova.io/wallet/news/feed"
...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::ZOA)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount zoaAvailableBalance = balance - immatureBalance - nLockedBalance;

    // ZOA Watch-Only Balance
    CAmount nTotalWatchBalance = watchOnlyBalance + watchUnconfBalance;
    CAmount nAvailableWatchBalance = watchOnlyBalance - watchImmatureBalance - nWatchOnlyLockedBalance;

    // ZOA labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, zoaAvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    // ZOA Available
    bool showZOAAvailable = settingShowAllBalances || zoaAvailableBalance != nTotalBalance;
    bool showWatchOnlyZOAAvailable = showZOAAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showZOAAvailable || showWatchOnlyZOAAvailable);
    ui->labelBalance->setVisible(showZOAAvailable || showWatchOnlyZOAAvailable);
    ui->labelWatchAvailable->setVisible(showZOAAvailable && showWatchOnly);

    // ZOA Pending
    bool showZOAPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyZOAPending = showZOAPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showZOAPending || showWatchOnlyZOAPending);
    ui->labelUnconfirmed->setVisible(showZOAPending || showWatchOnlyZOAPending);
    ui->labelWatchPending->setVisible(showZOAPending && showWatchOnly);
    ...
    // ZOA Locked
    bool showZOALocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyZOALocked = showZOALocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showZOALocked || showWatchOnlyZOALocked);
    ui->labelLockedBalance->setVisible(showZOALocked || showWatchOnlyZOALocked);
    ui->labelWatchLocked->setVisible(showZOALocked && showWatchOnly);
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default (ZOA)
    updateDisplayUnit();
}
...
void OverviewPage::SetLinks()
{
    ...
    ui->labelLinks3->setText("Facebook");
    ui->labelLinks4->setText("Twitter");
    ui->labelLinks5->setText("Telegram Chanel");
    ui->labelLinks6->setText("Github");
    ui->labelLinks7->setText("");

    ui->labelLinksUrl1->setText(": <a href=\"https://www.zotova.io/\">https://www.zotova.io</a>");
    ui->labelLinksUrl2->setText(": <a href=\"https://explorer.zotova.io/\">https://explorer.zotova.io</a>");
    ui->labelLinksUrl3->setText(": <a href=\"https://www.facebook.com/Zotovacoinofficial/\">https://www.facebook.com/Zotovacoinofficial/</a>");
    ui->labelLinksUrl4->setText(": <a href=\"https://twitter.com/zotovacoin\">https://twitter.com/zotovacoin</a>");
    ui->labelLinksUrl5->setText(": <a href=\"https://t.me/zotova_coin_news\">https://t.me/zotova_coin_news</a>");
    ui->labelLinksUrl6->setText(": <a href=\"https://github.com/ZotovaCoin\">https://github.com/ZotovaCoin</a>");
