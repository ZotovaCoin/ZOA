...
// Copyright (c) 2020 The ZOA developers
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "😻😻😻😻 Zotova Best Coin 2020 😻😻😻😻";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1579764816;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 1;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x07eba3d2e2893b614674a63b1df2f6d7681827951e20b00194799389e89f4e84"));
        assert(genesis.hashMerkleRoot == uint256("0xdfead7d6b982ba64d12e3fd2950ef6f4db0cc5f7172dde17a670e4e4e5d3cf9c"));

//        vSeeds.push_back(CDNSSeedData("seeder.zotova.org", "seeder.zotova.io"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x07)(0x77)(0xC2)(0x2E).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x07)(0x77)(0x7D)(0xF4).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x70)(0x10)(0x30)(0xde).convert_to_container<std::vector<unsigned char> >();
        ...
        nPoolMaxTransactions = 25;
        strSporkKey = "04b3a3103168b0306ec87f06aa68048aaa28c263d99728ec444faccb9384ed44d18eec602d798cef44fd3477afd539569c68c44f12bda5ae780124219662a71def";
