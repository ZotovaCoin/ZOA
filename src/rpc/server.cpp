...
string CRPCTable::help(string strCommand) const {
    ...
    BOOST_FOREACH(
    const PAIRTYPE(string,
    const CRPCCommand*) &command, vCommands) {
...
static const CRPCCommand vRPCCommands[] =
        {
                ...
                /* zotova features */
                {"zotova", "masternode", &masternode, true, true, false},
                {"zotova", "listmasternodes", &listmasternodes, true, true, false},
                {"zotova", "getmasternodecount", &getmasternodecount, true, true, false},
                {"zotova", "masternodeconnect", &masternodeconnect, true, true, false},
                {"zotova", "masternodecurrent", &masternodecurrent, true, true, false},
                {"zotova", "masternodedebug", &masternodedebug, true, true, false},
                {"zotova", "startmasternode", &startmasternode, true, true, false},
                {"zotova", "createmasternodekey", &createmasternodekey, true, true, false},
                {"zotova", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
                {"zotova", "listmasternodeconf", &listmasternodeconf, true, true, false},
                {"zotova", "getmasternodestatus", &getmasternodestatus, true, true, false},
                {"zotova", "getmasternodewinners", &getmasternodewinners, true, true, false},
                {"zotova", "getmasternodescores", &getmasternodescores, true, true, false},
                {"zotova", "mnbudget", &mnbudget, true, true, false},
                {"zotova", "preparebudget", &preparebudget, true, true, false},
                {"zotova", "submitbudget", &submitbudget, true, true, false},
                {"zotova", "mnbudgetvote", &mnbudgetvote, true, true, false},
                {"zotova", "getbudgetvotes", &getbudgetvotes, true, true, false},
                {"zotova", "getnextsuperblock", &getnextsuperblock, true, true, false},
                {"zotova", "getbudgetprojection", &getbudgetprojection, true, true, false},
                {"zotova", "getbudgetinfo", &getbudgetinfo, true, true, false},
                {"zotova", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
                {"zotova", "mnfinalbudget", &mnfinalbudget, true, true, false},
                {"zotova", "checkbudgets", &checkbudgets, true, true, false},
                {"zotova", "mnsync", &mnsync, true, true, false},
                {"zotova", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads() {
    ...
    {
        BOOST_FOREACH(
        const std::string &addr, mapMultiArgs["-rpcbind"]) {
            try {
    ...
    const ip::tcp::endpoint &endpoint, vEndpoints) {
        try {
            ...
            strerr = strprintf(_("An error occurred while setting up the RPC address %s port %u for listening: %s"),
                               straddress, endpoint.port(), e.what());
        }
    }
...
std::string HelpExampleCli(string methodname, string args) {
    return "> zotova-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args) {
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7781/\n";
}
