...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("zotova Core zotova-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zotova-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zotova transaction") + "\n" +
                               "  zotova-tx [options] -create [commands]   " + _("Create hex-encoded zotova transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zotova transaction
