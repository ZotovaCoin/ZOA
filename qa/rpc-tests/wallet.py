...
#   c) node1 mines 32 blocks, so now node 0 has 500000ZOA, node 1 has 4250ZOA, node2 has none.
#   d) node0 sends 601 ZOA to node2, in two transactions (301 ZOA, then 300 ZOA).
