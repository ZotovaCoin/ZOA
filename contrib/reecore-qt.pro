...
RESOURCES += src/qt/zotova.qrc src/qt/zotova_locale.qrc

TRANSLATIONS += src/qt/locale/zotova_bg.ts \
                src/qt/locale/zotova_de.ts \
                src/qt/locale/zotova_en.ts \
                src/qt/locale/zotova_es.ts \
                src/qt/locale/zotova_fi.ts \
                src/qt/locale/zotova_fr.ts \
                src/qt/locale/zotova_it.ts \
                src/qt/locale/zotova_ja.ts \
                src/qt/locale/zotova_pl.ts \
                src/qt/locale/zotova_pt.ts \
                src/qt/locale/zotova_ru.ts \
                src/qt/locale/zotova_sk.ts \
                src/qt/locale/zotova_sv.ts \
                src/qt/locale/zotova_vi.ts \
                src/qt/locale/zotova_zh_CN.ts \
                src/qt/locale/zotova_zh_TW.ts
