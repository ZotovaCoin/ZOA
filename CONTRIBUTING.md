Contributing to zotova Core
==================================

The zotova Core project operates an open contributor model where anyone is
...
The following applies to code changes to the zotova Core project, and is not to be
confused with overall zotova Network Protocol consensus changes.

Whether a pull request is merged into zotova Core rests with the project merge
...
Patches that change zotova consensus rules are considerably more involved than
...
Where a patch set proposes to change the zotova consensus, it must have been
...
The project leader is the release manager for each zotova Core release.
